...
static void timer_reinit(int f_sw) {
	...
	TIM_TimeBaseStructure.TIM_Period = (SYSTEM_CORE_CLOCK / (2.0 * f_sw)); //Since the counter counts up and down to complete 1 period, divide by 2 is required to get the set frequency.
