...
typedef enum {
	...
	CAN_PACKET_SET_POS_KP					= 64,
	CAN_PACKET_SET_POS_KI					= 65,
	CAN_PACKET_SET_POS_KD					= 66,
	CAN_PACKET_SET_POS_FILTER				= 67,
	CAN_PACKET_SET_POS_FLOATINGPOINT		= 68,
	CAN_PACKET_SET_MAX_SP_VEL				= 69,
	CAN_PACKET_SET_MAX_SP_ACCEL				= 70,
	CAN_PACKET_SET_MAX_SP_DECEL				= 71,
